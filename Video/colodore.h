...
public:
	...
	[[ nodiscard ]] inline uint32_t yiq2rgb ( const uint8_t y, const float i, const float q ) const
	{
		return	0xFF000000
	...
	[[ nodiscard ]] inline uint32_t yiq2rgb_sony ( const uint8_t y, const float i, const float q ) const
	{
		return	0xFF000000
