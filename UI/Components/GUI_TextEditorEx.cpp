...
void GUI_TextEditorEx::ClickoutSideListener::start ()
{
	juce::Desktop::getInstance ().addGlobalMouseListener ( this );
}
//-------------------------------------------------------------------------------------------------

void GUI_TextEditorEx::ClickoutSideListener::stop ()
{
...
void GUI_TextEditorEx::focusGained ( juce::Component::FocusChangeType fct )
{
	...
	clickoutSideListener.start ();

	if ( auto search = getParentComponent (); search && search->getProperties ().getWithDefault ( "type", "" ) == "searchBar" )
